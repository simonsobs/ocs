...
You can view the running containers with::
    ...
    6abefd9ea856   simonsobs/ocs-web:latest                        "nginx -g 'daemon of…"   27 seconds ago   Up 25 seconds   127.0.0.1:3002->80/tcp                         ocs-site-configs_ocs-web_1
...
hardware, viewing their datastreams in Grafana/OCS Web, write a :ref:`Client
