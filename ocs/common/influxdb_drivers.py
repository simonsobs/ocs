...
class InfluxBlock:
    ...
    def _format_line(self, fields, timestamp):
        """Given the fields and timestamps, format them for use in the 'line'
        protocol.
        ...
        Example:
            An example of the formatting::
                ...
                >>> block._format_line('channel_00=-0.0341,channel_01=0.0612', 1775162753.7786078)
    ...
    def _format_json(self, fields, timestamp):
        """Given the fields and timestamps, format them for use in the 'json'
        protocol.
        ...
        Example:
            An example of the formatting::
                ...
                >>> block._format_json({'channel_00': -0.1149, 'channel_01': -0.0038}, 1775163570.7786078)
    ...
    def encode(self, protocol='line'):
        ...
        Returns:
            list: List of encoded data points, formatted to be used by the
                InfluxDB client.
        ...
        if protocol == 'line':
            ...
            for fields, time_ in zip(grouped_data, self.timestamps):
                text = self._format_json(fields, time_)
                if text is not None:
...
def _convert_single_to_group(message):
    ...
    'timestamps' format, which we can format.
